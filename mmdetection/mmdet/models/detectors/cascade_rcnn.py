...
from mmdet.core import (assign_and_sample, bbox2result, multi_apply)
from mmdet.core import (bbox2roi, merge_aug_bboxes, merge_aug_masks, multiclass_nms)
...
class CascadeRCNN(BaseDetector, RPNTestMixin):
    ...
    def aug_test(self, imgs, img_metas, rescale=False):
        ...
        merged_bboxes, merged_scores = torch.cat(recovered_bboxes, 0), torch.cat(aug_scores, 0)
